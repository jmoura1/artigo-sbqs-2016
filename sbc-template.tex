...
%precisa analisar os casos
%preicsa criar na mão cada cenário
% trabalhoso caso se queira testar os diversos caminhos que um processo pode ter e também se o processo for extenso
