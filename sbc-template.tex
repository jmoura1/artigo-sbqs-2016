...
\section{Introdução}
 ...
 \begin{itemize}
   ...
   \end{itemize}
   \item Para melhora na criação dos testes: analisar o diagrama no formato BPMN, utilizando um parse, para gerar informações
     \begin{itemize}
...
\item Alguns rabalhos relacionados
\end{itemize}
