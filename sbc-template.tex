...
%tasks
\emph{Tasks} são a menor parte de um processo, são utilizadas quando o processo não pode ser dividido mais detalhadamente. Geralmente as Tasks são executadas por um usuário final ou por uma aplicação. Existem diferentes tipos de Tasks para representar o diferente comportamente que tava tarefa pode representar. Por exemplo, uma \emph{userTask} representa uma tarefa em que um usuário deve executar uma ação.
